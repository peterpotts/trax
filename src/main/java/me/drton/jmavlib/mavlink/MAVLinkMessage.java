...
public class MAVLinkMessage {
    ...
    public String toString() {
        ...
        return String.format("<MAVLinkMessage %s seq=%s sysID=%s compID=%s ver=%s ID=%s CRC=%04x %s/>",
                             definition.name,
                             sequence & 0xff, systemID, componentID, protocolVersion, msgID, crc, sb.toString());
    }
}
